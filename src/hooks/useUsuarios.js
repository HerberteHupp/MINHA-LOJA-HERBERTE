...
export function useVerificaLogin() {
  ...
  //Usando o useEffect, para pegar a lista de usuarios, assim que o componente é renderizado na tela
  useEffect(() => {
  ...
  // Função pra verificar se o usuário passado existe na lista que puxou da API
  const verificaLogin = (data) => {
    ...
    if(userToFind != undefined && userToFind.senha == data.senha){
        ...
        //passa o ususário logado par o contexto
        login(userToFind)
        return "Login efetuado com sucesso"
    }
    // Caso o usuário não exista ou senha esteja errada, retorna uma mensagem de erro
    else{
